...
def generate_launch_description():
    ...
    web_cmd_vel_topic = LaunchConfiguration('web_cmd_vel_topic')
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument(
            'ekf_config',
            default_value=os.path.expanduser('~/arya_ws/src/amr_bringup_headless/config/ekf.yaml')
        ),
        ...
        DeclareLaunchArgument(
            ...
            description='Topic used by the web/manual joystick so it does not collide with Nav2 /cmd_vel.'
        ),
